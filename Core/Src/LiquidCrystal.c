...
bool lcd16x2_i2c_init(I2C_HandleTypeDef *pI2cHandle)
{
    ...
    if(HAL_I2C_IsDeviceReady(lcd16x2_i2cHandle, LCD_I2C_SLAVE_ADDRESS_0, 10, 500) != HAL_OK)
    {
        if(HAL_I2C_IsDeviceReady(lcd16x2_i2cHandle, LCD_I2C_SLAVE_ADDRESS_1, 10, 500) != HAL_OK)
        {
            return false;
        }
        else
